...
namespace UnitTests.Pages.Product.Index_HomeAppliances
{
    /// <summary>
    ...
    public class IndexTests
    {
        ...
        public static Index_HomeAppliancesModel pageModel;
        ...
        public void TestInitialize()
        {
            ...
            var MockLoggerDirect = Mock.Of<ILogger<Index_HomeAppliancesModel>>();
            JsonFileProductService productService;
            // json handler
            productService = new JsonFileProductService(mockWebHostEnvironment.Object);
            // new page model
            pageModel = new Index_HomeAppliancesModel(productService)
            {
            };
        }
        ...
        #region OnGet
        [Test]
        public void OnGet_Valid_Should_Return_Product_Count()
        {
            // Arrange
