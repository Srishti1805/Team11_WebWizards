...
namespace UnitTests.Pages.Product.Index_camping
{
    /// <summary>
    ...
    public class IndexTests
    {
        ...
        public static Index_campingModel pageModel;
        ...
        public void TestInitialize()
        {
            ...
            var MockLoggerDirect = Mock.Of<ILogger<Index_campingModel>>();
            JsonFileProductService productService;
            // json handler
            productService = new JsonFileProductService(mockWebHostEnvironment.Object);
            // new page model
            pageModel = new Index_campingModel(productService)
            {
            };
        }
