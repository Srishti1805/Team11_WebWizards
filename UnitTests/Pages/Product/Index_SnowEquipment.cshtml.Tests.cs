...
namespace UnitTests.Pages.Product.Index_SnowEquipment
{
    /// <summary>
    ...
    public class IndexTests
    {
        ...
        public static Index_SnowEquipmentModel pageModel;
        ...
        public void TestInitialize()
        {
            ...
            var MockLoggerDirect = Mock.Of<ILogger<Index_SnowEquipmentModel>>();
            JsonFileProductService productService;
            // json handler
            productService = new JsonFileProductService(mockWebHostEnvironment.Object);
            // new page model
            pageModel = new Index_SnowEquipmentModel(productService)
            {
            };
        }
