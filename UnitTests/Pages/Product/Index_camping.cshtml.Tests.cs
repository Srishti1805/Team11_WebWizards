...
namespace UnitTests.Pages.Product.Index_gardening
{
    /// <summary>
    ...
    public class IndexTests
    {
        ...
        public static Index_gardeningModel pageModel;
        ...
        public void TestInitialize()
        {
            ...
            var MockLoggerDirect = Mock.Of<ILogger<Index_gardeningModel>>();
            JsonFileProductService productService;
            // json handler
            productService = new JsonFileProductService(mockWebHostEnvironment.Object);
            // new page model
            pageModel = new Index_gardeningModel(productService)
            {
            };
        }
